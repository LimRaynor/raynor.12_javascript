...
/* 객체 등급 분류
* 1급 : 변수 할당이 있으며, 인자가 있고, 반환값이 있다
* 2급 : 변수 할당이 없고, 인자가 있고, 반환값이 없다
* 3급 : 변수 할당이 없고, 인자가 없고, 반환값이 없다
*  */
...
// 1급 객체는 결과 값을 반환 할 수 있다.
var repeat = (func, count) => {

    for (var i=0;  i < count; i++) {
        console.log(func());
    }
    return () => console.log(`${count}번 반복 완료`); // 몇번 반복되었는지 함수값을 반환
};  // (func, count) ->  (callback, 고착함수)
