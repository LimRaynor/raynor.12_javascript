...
const now = Date.now();
console.log(now);
console.log(new Date(now));  // +9


// Date.parse : 1970년 1월 1일 00:00:00(UTC)을 기점으로 인수로 전달된
...
console.log(Date.UTC(1970, 0, 1)); // 1970-01-01
console.log('----------Date.UTC--------');

// 연, 월, 일, 시, 분, 초, 밀리초 반환 및 설정
const date = new Date();
console.log(date.getFullYear());
console.log(date.getMonth());   // 0부터 11까지로 계산되서 출력
...
console.log(date);
console.log('-------------연, 월, 일, 시, 분, 초, 밀리초 반환-----------');
