...
const theater = {
    ...
    showMovieList(){
        ...
        this.titles.forEach((title) => {
            ...
            // 연결하지 않는다. -> 화살표 함수 밖에 있는 theater 객체가 this와 매핑된다.
            console.log(this.store,  title); //  this.store == 강남점
        });
        // theater.showMovieList(); // 무한루프 걸림 여기쓰면
    }
};
    const testFn = () => {
        console.log(this); // this == global(아무것도 감싸지 않았을때 매핑)
    }
    testFn()
...
class Tiger extends Animal {
    move(lostWeight) {
        ...
        // 일반함수 에서  this == -> function -> object
        // 화살표 함스에서 this == -> tiger -> animal
    }
}
