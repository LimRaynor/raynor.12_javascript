...
// || == or 연산자라 앞이 true라서 뒤에상관없이 true

// 1) 'apple'은 Truthy한 값이기 때문에 true로 평가되고
// 2) 평가 도중 true가 발생하면(확정되면) 나머지 연산을 수행하지 않음
...
// &&연산은 좌항, 우항을 모두 평가해야 되기 때문에
// && 연산은 뒤쪽(우항)이 평가의 결과를 결정함
//   -> 좌항 true면 우항이 반환됨
console.log('apple' && 'banana');
console.log(false && 'banana');

/* 객체를 가리키기를 기대하는 변수가 null 또는 undefined인지 확인 하고
* null 또는 undefined -> (Falsy)로 판단되면
* 객체의 속성(프로퍼티)를 참조를 막아서 에러를 예방  */
var obj = null;
// Cannot read properties of null == null ponit inception
//var temp = obj.value;
