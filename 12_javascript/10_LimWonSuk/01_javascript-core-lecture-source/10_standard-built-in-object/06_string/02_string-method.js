...
// writable : false,  configurable: false == 불변객체
console.log('--------------------------------');
...
console.log(str.startsWith('Ja')); // 시작하는곳
console.log(str.startsWith('va', 2));   // 검색 시작 인덱스 지정
console.log(str.endsWith('pt')); // 끝나는곳
...
console.log(str3.split(''));        // 인수로 "빈 문자열"을 전달하면 각 문자를 모두 분리
// -> 모든 글자를 하나하나 다쪼갬
