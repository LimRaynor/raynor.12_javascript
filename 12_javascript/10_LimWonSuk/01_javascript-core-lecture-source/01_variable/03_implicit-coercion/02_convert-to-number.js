...
console.log(10 / `3`); // `3` -> 3
console.log(10 % `3`); // `3` -> 3
console.log(10 % `삼`); // NaN -> `삼`을 number로 변경할 수 없기 때문에 NaN  출력
...
console.log(`10 > 'a' : ${10 > 'a'}`); // a가 큰게 아니라 비교자체가 실패핵서 false
...
console.log(+{}); // 객체, NaN
console.log(+[]); // 배열, 빈 배열이라는 뜻 -> 0
console.log(+[`a`]); // 배열, NaN
console.log(+[1,2,3]); // 배열, NaN
console.log(+[999,888]); // 배열, NaN -> (여러 인덱스가 있어 무엇을 숫자로 변환할지 모름)
console.log(+[10]); // 배열,10
